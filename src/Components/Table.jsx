...
import { fetchUserData } from "../redux/slice/tableSlice";
...
const Table = () => {
  ...
  useEffect(() => {
    const handler = (event) => {
      if (editDropDown && ref.current && !ref.current?.contains(event.target)) {
  ...
  return (
    <>
      ...
      {open && <UserForm editId={editId} handlClose={handlClose} open={open} />}
      ...
      <div className="flex flex-col gap-5 p-3">
        <div className="flex fle-row justify-between items-center">
          ...
          <button
            ...
            type="button"
            className="flex w-[200px] mt-3 mr self-end text-center h-11 mr-3 items-center bg-blue-950 justify-center text-white bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-primary-600 dark:hover:bg-primary-700 focus:outline-none dark:focus:ring-primary-800"
          >
            <svg
                ...
                <tr key={index} className="border-b dark:border-gray-700">
                  ...
                  <td className="px-4 relative" ref={ref}>
                    <button
                      ...
                      type="button"
                      onClick={() => setEditDropDown(element.id)}
                    >
                      <svg
                        className="w-5 h-5"
                        aria-hidden="true"
                    ...
                    {editDropDown === element.id && (
                      <div
                        ref={ref}
                        className=" absolute right-[3px] z-10 w-44 bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600"
                      >
